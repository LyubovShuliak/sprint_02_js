function capital_first_character(name) { // senya
...
function greet() {
    ...
    const last_name = prompt("Please, enter your first name", "")
    if (last_name.match(pattern)) {
        return "Wrong input!"
    }
    return `Hello, ${capital_first_character(first_name)} ${capital_first_character(last_name)}`
}
